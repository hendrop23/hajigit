...
class Page2OptionThreeScreen extends StatelessWidget {
  ...
  return SizedBox(
    ...
    child: ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        VoidCallback onTap;onTap = () {};
        if (index == 0) {
          itemText = "Hak Jemaah ";
          itemImagePath = ImageConstant.imgA1ede62066b1eec;
          onTap = () {
      Navigator.pushNamed(context, AppRoutes.hakJemaahScreen);
    };
        } else if (index == 1) {
          itemText = "Wajib Haji";
      ...
      Navigator.pushNamed(context, AppRoutes.larangannIhramScreen);
          ...
          onTap = () {
      Navigator.pushNamed(context, AppRoutes.nextPageOneScreen);
    };
        }
        return TextlistItemWidget(text: itemText, imagePath: itemImagePath, onTap:onTap);
      },
    ),
  );
}
  ...
  return Padding(
    ...
    onTap = () {
      Navigator.pushNamed(context, AppRoutes.tataCaraHajiWanitaScreen);
    };
  } else if (index == 1) {
  ...
  return StacklistItemWidget(text: itemText, imagePath: itemImagePath, onTap: onTap,);
},
    ),
  );
}
      ...
      child: Row(
        ...
        children: [
          ...
          onTap: () {
            ...
            Navigator.pushNamed(context, AppRoutes.hikmahHajiScreen);
          },
          child:
                  CustomImageView(
